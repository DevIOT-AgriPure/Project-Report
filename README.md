...
Andres Reynoso (TP): Con el desarrollo de los wireframes y mockups, he entendido y pensado cómo se sentiría mi segmento objetivo al usar mi aplicación. | TB1: A través de este proceso, hemos adquirido un conocimiento más profundo del ámbito empresarial y hemos identificado las expectativas de sus usuarios, sentando así una base sólida para el desarrollo de su proyecto. TP: En el proceso de desarrollo de los wireframes y mockups, hemos logrado una comprensión más profunda de cómo nuestros segmentos objetivo se sentirían al utilizar nuestra aplicación. Esta etapa nos ha permitido poner en práctica no solo nuestras habilidades técnicas, sino también nuestra empatía hacia los usuarios.|
